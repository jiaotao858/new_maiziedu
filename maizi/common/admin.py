...
class UserProfileAdmin(UserAdmin):
    ...
    ordering = ('username',)
    filter_horizontal = ('groups', 'user_permissions',)         # 优化多选框显示方式,横向显示
    # filter_vertical = ('groups', 'user_permissions',)         # 优化多选框显示方式，竖着显示
...
class CourseAdmin(admin.ModelAdmin):
    ...
    list_display = ('name','student_count','date_publish')
    date_hierarchy = 'date_publish'
    raw_id_fields = ('teacher',)  # 显示外键的的详细信息，不是使用下拉框来显示的
    # fields = ('','','') 显示表单顺序，只显示需要显示的内容，如果未写在fields中则不显示
